...
You can use a specific `version` of this action. The latest published version is `v1.2.24`. You can also use `latest` to always get the latest version.
  ...
  coverage:
    ...
    steps:
      ...
      - name: Deploy coverage
        uses: tangro/actions-deploy@v1.2.24
        with:
          context: auto
